...
(function($){
	$.fn.extend({ 
		...
		var randID =  Math.round(Math.random()*100000000);
			...
			$(obj).prepend('<div id="dragwrapper'+randID+'"><div id="drag'+randID+'"><img width="8" height="56" alt="handle" src="'+o.imagePath+'smart/js/handle.gif" id="handle'+randID+'" /></div></div>'); // Create drag handle
			...
			$(obj).append('<img src="'+o.imagePath+'smart/js/lt-small.png" id="lt-arrow'+randID+'"><img src="'+o.imagePath+'smart/js/rt-small.png" id="rt-arrow'+randID+'">');
