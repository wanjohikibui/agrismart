...
var properties = L.geoJson(null, {
  ...
  onEachFeature: function (feature, layer) {
    if (feature.properties) {
      var content = "<table class='table table-striped table-bordered table-condensed'>" + "<tr><th>Name</th><td>" + feature.properties.NAME + "</td></tr>" + "<tr><th>Contact</th><td>" + feature.properties.Agency + "</td></tr>" + "<tr><th>Price</th><td>" + feature.properties.ADRESS1 + "</td></tr>" + "<tr><th>Website</th><td><a class='url-break' href='" + feature.properties.URL + "' target='_blank'>" + feature.properties.URL + "</a></td></tr>" + "<table>";
      layer.on({
        click: function (e) {
...
$.getJSON("data/samplehomes.geojson", function (data) {
...
var groupedOverlays = {
  "Listed Properties": {
    "<img src='assets/img/home.png' width='24' height='28'>&nbsp;Properties": propertyLayer,
...
$(document).one("ajaxStop", function () {
  $("#loading").hide();
  sizeLayerControl();
  /* Fit map to Listed homes bounds */
  ...
  $("#searchbox").typeahead({
    ...
    templates: {
      header: "<h4 class='typeahead-header'><img src='assets/img/home.png' width='24' height='28'>&nbsp;Properties</h4>",
